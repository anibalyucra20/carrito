                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        ...
                                        <p class="text-muted mb-4">Ingresa tu Usuario y Contraseña para Acceder Administrativo</p>
                                        <form class="user">
                                            ...
                                            <a href="" class="btn btn-success btn-block waves-effect waves-light"> Iniciar Sesión </a>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-12 text-center">
                                                <p class="text-muted mb-2"><a href="pages-recoverpw.html" class="text-muted font-weight-medium ml-1">Ovidé mi Contraseña</a></p>
